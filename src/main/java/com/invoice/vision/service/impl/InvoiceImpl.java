...
public class InvoiceImpl implements Invoice {
    ...
    @Override
    public void uploadInvoice(MultipartFile multipartFile) throws Exception {
    ...
    @Override
    public OcrPageDto detectText(MultipartFile multipartFile) throws Exception {
        return detectText.detectText(multipartFile);
    }
